  ...
  <div class="columns field">
    <div class="column is-half is-offset-one-quarter control">
      ...
      <div class="mx-auto mb-2 w-full max-w-md columns-2">
        <CommonSelectInput v-model:selectTarget="searchInfo.selectComparisonOperator" :select-items="operatorKind" />
        <div>
          <input
      ...
      <div class="mx-auto w-full max-w-md flex gap-x-2">
        <ArrowPathIcon class="cursor-pointer h-8 w-8 text-blue-400" @click="resetSearchInfo" />
        <FavoriteSearch />
      </div>
    </div>
  </div>
